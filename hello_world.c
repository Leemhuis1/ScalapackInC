...
//		printf("This is process 1 from inside if - clause\n");
	...
	int bfc = n / numc; //blocking factor columns 	// = 1 ( = bsy)
	int bfr = n / numr; //blocking factor rows 	// = 4 ( = bsx)
	...
	int bsyB = 1; //blocksize in Y direction
	...
	int bfcB = 1 / numcB;	//blocking factor - row (blocksize in rows)
